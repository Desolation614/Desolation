...
public class CombatHitDefinitions {
	...
	public CombatHitDefinitions(Entity target, int weaponId, int maxDamage,
			boolean isSpecialOn, short[] bonuses, boolean meleeDeflectPray,
			boolean rangeDeflectPray, boolean protectPray,
			boolean soulSplitPray, boolean sapWarrior, boolean sapRanger,
			boolean sapSpirit, boolean leechAttack, boolean leechRanged,
			boolean leechDefence, boolean leechStrength, boolean turmoil) {
